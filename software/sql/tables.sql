...
CREATE TABLE IF NOT EXISTS FIRM (
    ...
    TOTAL_VALUE NUMERIC(20, 2) NOT NULL CHECK(TOTAL_VALUE >= 0),  -- Total value of the firm (cash + investments)
...
CREATE TABLE IF NOT EXISTS PORTFOLIO (
    ...
    AVERAGE_PURCHASE_PRICE REAL CHECK(AVERAGE_PURCHASE_PRICE >= 0),
    ...
    -- Generated column for the total value of the stock
    TOTAL_VALUE REAL GENERATED ALWAYS AS (SHARES * CURRENT_PRICE) STORED,
    -- Unrealized profit/loss (to be updated via trigger)
    UNREALIZED_PROFIT_LOSS REAL DEFAULT 0,
    DIVIDEND_YIELD_PERCENTAGE REAL DEFAULT 0 CHECK(DIVIDEND_YIELD_PERCENTAGE >= 0),
    DIVIDEND_YIELD_AMOUNT REAL DEFAULT 0 CHECK(DIVIDEND_YIELD_AMOUNT >= 0),
    TOTAL_DIVIDENDS_RECEIVED REAL DEFAULT 0 CHECK(TOTAL_DIVIDENDS_RECEIVED >= 0),
